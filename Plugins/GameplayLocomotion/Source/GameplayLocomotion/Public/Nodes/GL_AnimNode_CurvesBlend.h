...
#include "GL_AnimNode_CurvesBlend.generated.h"

UENUM(BlueprintType)
enum class EGL_CurvesBlendMode : uint8
{
...
struct GAMEPLAYLOCOMOTION_API FGL_AnimNode_CurvesBlend : public FAnimNode_Base
{
	GENERATED_BODY()
...
protected:
	...
	EGL_CurvesBlendMode BlendMode{ EGL_CurvesBlendMode::BlendByAmount};
#endif
...
public:
	...
	EGL_CurvesBlendMode GetBlendMode() const;
};
